   ...
   PQfine.prototype = {
      ...
      shortcut: function () {
         ...
         for (var prop in this.$data) {
            ...
            (function(prop){
               if((typeof self_instance[prop]) !=='object'){
                  Object.defineProperty(self_instance,prop,{
                     get:function(){
                        return self_instance.$data[prop];
                     },
                     set:function(value){
                        if(value!=self_instance.$data[prop]){
                           self_instance.$data[prop]=value;
                        }
                     }
                  })
               }
